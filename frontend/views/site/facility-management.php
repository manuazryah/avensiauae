                ...
                <div class="service-cont-box">
                    ...
                    if ($facility_service->image != '') {
                        ...
                        if (file_exists($dirPath)) {
                            echo '<div class="img-box"><img class="img-responsive" src="' . Yii::$app->homeUrl . 'uploads/it/services/' . $facility_service->id . '/' . $facility_service->id . '.' . $facility_service->image . '"/> </div>';
                        } else {
                            echo '';
                        }
                    } else {
