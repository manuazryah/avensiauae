			...
			<div class="sidebar-menu toggle-others fixed">
				...
				<div class="sidebar-menu-inner">
					...
					<ul id="main-menu" class="main-menu">
						...
						<li>
							<?= Html::a('<i class="fa fa-tags"></i> <span class="title">Avensia Tech Content</span>', ['/cms/avensia-tech-content/update', 'id' => 1], ['class' => 'title']) ?>
						</li>
						<li>
							<?= Html::a('<i class="fa fa-tags"></i> <span class="title">Facility Management</span>', ['/cms/facility-management/index'], ['class' => 'title']) ?>
						</li>
					</ul>
